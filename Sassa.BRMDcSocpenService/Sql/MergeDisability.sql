--merge disability stats to old age records
DECLARE 
    CURSOR c1 IS SELECT beneficiary_id, CAPTURE_REFERENCE, CAPTURE_DATE, SCAN_DATE, SOCPEN_DATE, CS_DATE, TDW_REC FROM DC_Socpen where grant_type = '3';
BEGIN
