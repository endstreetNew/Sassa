...
namespace Sassa.Brm.Common.Helpers
{
    public static class BulkPrint
    {
        public static string Header()
        {
            ...
            sb.Append(" <style> @page { size: A4 portrait; } .column { float: left; width: 33.33%; } /* Clear floats after the columns */ .row:after { content: \"\"; display: table; clear: both; } .centered { text-align: center } .right { text-align: right } .barright { position: relative; top:-100px; height: 0px; } qrcode { width: 100px; height: 100px } .rotate { transform: rotate(90deg); transform-origin: 0 100%; zoom: 1; position: absolute; left:700px; /* height: 380px;*/ width: 200px } .chkboxLabel { display: inline; padding-left: 5px; font-size: 10px; font-weight: 400 } h2, .h2 { font-size: calc(1.325rem + 0.9vw); } page[size=\"A4\"] { background: white; width: 21cm; height: 29.7cm; display: block; /*margin: 0 auto;*/ margin: 0.5cm; /*box-shadow: 0 0 0.5cm rgba(0,0,0,0.5);*/ } @media print { body, page[size=\"A4\"] { margin: 0; box-shadow: 0; } p { page-break-after: always } } </style>");
            sb.Append("</head> ");
            sb.Append("<body> ");
