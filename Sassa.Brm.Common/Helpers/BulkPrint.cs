...
namespace Sassa.Brm.Common.Helpers
{
    public static class BulkPrint
    {
        public static string Header()
        {
            ...
            sb.Append(" <style> @page { size: A4 portrait; } .column { float: left; width: 33.33%; } /* Clear floats after the columns */ .row:after { content: \"\"; display: table; clear: both; } .centered { text-align: center } .right { text-align: right } .barright { position: absolute; left: 110mm; } qrcode { width: 100px; height: 100px } .rotate { -webkit-transform: rotate(90deg); -webkit-transform-origin: 0 100%; -moz-transform: rotate(90deg); -moz-transform-origin: 0 100%; -ms-transform: rotate(90deg); -ms-transform-origin: 0 100%; -o-transform: rotate(90deg); -o-transform-origin: 0 100%; transform: rotate(90deg); transform-origin: 0 100%; zoom: 1; position: absolute; left: 100mm; height: 10px; width: 200px } .chkboxLabel { display: inline; padding-left: 5px; font-size: 10px; font-weight: 400 } h2, .h2 { font-size: calc(1.325rem + 0.9vw); } page[size=\"A4\"] { background: white; width: 21cm; height: 29.7cm; display: block; /*margin: 0 auto;*/ margin: 0.5cm; /*box-shadow: 0 0 0.5cm rgba(0,0,0,0.5);*/ } @media print { body, page[size=\"A4\"] { margin: 0; box-shadow: 0; } p { page-break-after: always } } </style>");
            sb.Append("</head> ");
            sb.Append("<body> ");
        ...
        public static string CreateFileCover(DcFile file, string GrantType, string RegionName, string LcType, List<RequiredDocsView> docs)
        {
            try
            {
            ...
            StringBuilder sb = new StringBuilder();
                ...
                sb.Append("</div>");
                //Middle
                sb.Append("<div class=\"column centered\">");
                ...
                sb.Append("</div>");
                //Right
                sb.Append("<div class=\"column right\">");
                ...
                sb.Append($"<div>Archive Year: {file.ArchiveYear}");
                sb.Append("</div>");
                ...
                sb.Append("<br />");
                sb.Append("<div class=\"row\">");
                sb.Append("<div class=\"column\" style=\"width:85%\">");
                foreach (var section in "General Particulars|Particulars of Income|Particulars of Assets".Split('|'))
                {
                    ...
                    int EvenCol = 0;
                    sb.Append("<div class=\"row\">");
                    sb.Append("<div class=\"column\" style=\"width:50%\">");
