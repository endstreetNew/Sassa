                    ...
                    switch (rIndex)
                    {
                        ...
                        case "12":
                            cmd.CommandText = $@"SELECT  r.Region_NAME,b.BENEFICIARY_ID , g.TYPE_NAME, max(b.Application_date) AS Application_date,b.NAME,b.SURNAME , b.Paypoint FROM DC_SOCPEN b --,b.NAME,b.SURNAME , b.Paypoint 
                                                ...
                                                AND b.CAPTURE_REFERENCE is null AND b.Scan_date is null and cs_date is null and b.TDW_REC IS NULL and b.Mis_file is null and b.ECMIS_FILE is null and b.OGA_DATE is null 
