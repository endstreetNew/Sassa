...
public class ReportDataService
{
    ...
    public List<CsvListItem> GetFiles(string username)
    {
        string[] files = new string[0];
        try
        {
            files = Directory.GetFiles(StaticDataService.ReportFolder, $"*.*");
        }
        catch //(Exception ex)
        {

        }
        List<CsvListItem> result = new List<CsvListItem>();
    ...
    public List<CsvListItem> GetTdwFiles(string regionCode, string username, int page)
    {
